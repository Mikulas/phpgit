...
use Respekt\InvalidArgumentException;
...
class HelperLoader extends Object
{
	...
	/**
	 * @param       $count
	 * @param array $forms [one, few, many/zero]
	 * @return string
	 */
	public function plural($count, array $forms)
	{
		$count = (int) $count;
		if (count($forms) !== 3) {
			throw new InvalidArgumentException('Usage: forms should be [one, few, many/zero]');
		}
